...
const Button = ({
    ...
    const variants = {
        ...
        secondary: "border-2 border-[var(--color-border-button)] bg-[var(--color-secondary-button)] text-[var(--color-border-button)] hover:bg-[var(--color-secondary-button-hover)] active:bg-[var(--color-secondary-button-active)] shadow-sm",
    }
